  ...
  return (
    <footer className={styles.footer}>
      <div className={`${styles.grid} container`}>
        ...
        <div className={styles.column}>
          <Link href="/" className={styles.logo} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 800, fontSize: '1.4rem', color: '#fff', fontFamily: 'var(--font-display)' }}>
            ...
            <span>Jai baba Tours and Travels TRAVELS</span>
          </Link>
          <p className={styles.brandDesc}>
            Discover beautiful destinations, custom tour packages, and make unforgettable memories. Jai baba Tours and Travels Tour and Travels is your reliable partner for planning perfect vacations.
          </p>
      ...
      <div className={`${styles.bottomBar} container`}>
        <p>&copy; {new Date().getFullYear()} Jai baba Tours and Travels Tour and Travels. All rights reserved.</p>
