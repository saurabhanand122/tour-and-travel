      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.tagline}>
            Explore exotic beaches, snowy mountains, and historic cities with Jai baba Tours and Travels Tour and Travels. Custom packages tailored just for you.
          </p>
        </div>
      ...
      <section className={styles.section} style={{ background: 'var(--bg-secondary)', borderTop: '1px solid var(--border-light)', borderBottom: '1px solid var(--border-light)' }}>
        <div className={`${styles.section} container`} style={{ padding: 0 }}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>Why Choose Jai baba Tours and Travels Travels</h2>
            <p className={styles.sectionText}>
        ...
        <div className={styles.testimonialsGrid}>
          <div className={`${styles.testimonialCard} glass-panel`}>
            ...
            <p className={styles.comment}>
              "Our family trip to Bali with Jai baba Tours and Travels Travels was absolutely mind-blowing. The villa accommodations were premium and our tour driver was exceptionally kind."
            </p>
          ...
          <div className={`${styles.testimonialCard} glass-panel`}>
            ...
            <div className={styles.rating}>★★★★★</div>
            <p className={styles.comment}>
              "Japan is complex to navigate, but Jai baba Tours and Travels travels provided a seamless guide, JR passes, and restaurant recommendations that made the journey extremely easy!"
            </p>
            <div className={styles.userProfile}>
